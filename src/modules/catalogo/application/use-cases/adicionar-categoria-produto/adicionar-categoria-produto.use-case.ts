...
export class AdicionarCategoriaProdutoUseCase implements IUseCase<RecuperarProdutoProps, boolean> {
    ...
    async execute(produtoProps: RecuperarProdutoProps): Promise<boolean> {
        ...
        const produtoCategoriaAdicionada = await this._produtoRepositorio.adicionarCategoria(produto, categoria)
